...
const Footer: React.FC = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">LuminaTech LED</span>
            </div>
            <p className="text-gray-400">
              Leading provider of professional LED lighting solutions for businesses worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400">LED Consultation</span></li>
              <li><span className="text-gray-400">Custom Design</span></li>
              <li><span className="text-gray-400">Installation</span></li>
              <li><span className="text-gray-400">Maintenance</span></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@luminatech.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="h-5 w-5 text-blue-400" />
                <span className="text-gray-400">123 LED Street, Tech City, TC 12345</span>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 LuminaTech LED. All rights reserved. | Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
